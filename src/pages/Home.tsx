...
import { ArrowRight, Shield, MapPin, CheckCircle2, Wrench, Camera, Car, Fingerprint, Zap, ClipboardCheck, ShieldCheck, Network, Cable, FileText, Server, Users } from "lucide-react";
      ...
      <section className="bg-section-dark py-12 md:py-16 flex items-center min-h-[420px] md:min-h-[480px]">
        <div className="container-narrow w-full min-w-0">
          <div className="max-w-4xl min-w-0">
            ...
            <p className="text-base md:text-lg text-white font-medium max-w-3xl mb-6 leading-relaxed">
              Gated community security systems for RWAs, builders and facility managers across Hyderabad, Telangana &amp; Andhra Pradesh.
            </p>
